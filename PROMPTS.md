Can you help me create a unique and interactive section for my DevConf 2026 landing page using only HTML and CSS?

I want the section to be called “Build Your DevConf Quest.” Can you make it so visitors can choose one of four tracks: AI/ML, Cloud, Frontend, or Security?

When someone clicks a track, can the section show a different conference route for that track without using JavaScript? Please use hidden radio buttons, labels, and CSS checked selectors for the interaction.
